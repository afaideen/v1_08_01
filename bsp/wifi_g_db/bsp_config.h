/*******************************************************************************
  ...
  Summary:      
    Board Support Package Header file for Wi-Fi G Demo Board with a
    PIC32MX695F512H on it.

  Description:
    This file contains constants, macros, type definitions and function
    declarations required by the Wi-Fi G Demo Board with a PIC32MX695F512H
    on it.
*******************************************************************************/
...
typedef enum
{
    ...
    /* SWITCH 0 */
     BSP_SWITCH_0 = /*DOM-IGNORE-BEGIN*/PORTS_BIT_POS_9/*DOM-IGNORE-END*/,
             BSP_SWITCH_1 = 1,
             BSP_SWITCH_2 = 1,
             BSP_SWITCH_3 = 1,
             BSP_SWITCH_4 = 1,
...
typedef enum
{
    ...
    /* LED 2, D8, is connected to RF0, so the actual BIT POS is also 0 */
