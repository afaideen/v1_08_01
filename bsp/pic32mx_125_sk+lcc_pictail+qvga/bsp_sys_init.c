/*******************************************************************************
  ...
  Summary:
    Board Support Package implementation for PIC32MX USB Starter Kit II when
    used along with the Low-Cost Controllerless (LCC) Graphics PICtail Plus
    Daughter Board and a WQVGA display.

  Description:
    This file contains routines that implement the board support package for
    PIC32MX USB Starter Kit II when used along with a Low-Cost Controllerless
    (LCC) Graphics PICtail Plus Daughter Board and a WQVGA display.
*******************************************************************************/
