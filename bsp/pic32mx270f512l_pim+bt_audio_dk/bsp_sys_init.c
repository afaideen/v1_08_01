/*******************************************************************************
  ...
  Summary:
    Board Support Package implementation for Bluetooth Audio Development Kit
...
void BSP_Initialize(void )
{
    ...
    PLIB_PORTS_PinSet(PORTS_ID_0, PORT_CHANNEL_A, BSP_LED_5);
    PLIB_PORTS_PinSet(PORTS_ID_0, PORT_CHANNEL_A, BSP_LED_6);
    PLIB_PORTS_PinSet(PORTS_ID_0, PORT_CHANNEL_A, BSP_LED_7);
    PLIB_PORTS_PinSet(PORTS_ID_0, PORT_CHANNEL_A, BSP_LED_8);
    PLIB_PORTS_PinSet(PORTS_ID_0, PORT_CHANNEL_A, BSP_LED_9);
...
{
    if((bspSwitch == BSP_SWITCH_4) || (bspSwitch == BSP_SWITCH_5))
    {
