/*******************************************************************************
  ...
  Summary:
    ...
    used along with the Graphics PICtail Plus Epson S1D13517 Board and a WQVGA
    display.

  Description:
    This file contains routines that implement the board support package for
    PIC32MX USB Starter Kit II when used along with a Graphics PICtail Plus
    Epson S1D13517 Board and a WQVGA display.
*******************************************************************************/
