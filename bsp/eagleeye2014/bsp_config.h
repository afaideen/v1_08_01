...
typedef enum
{
    ...
    /* SWITCH 4 */
     ...
     /* SWITCH 5 */
     BSP_SWITCH_3 = PORTS_BIT_POS_13,///*DOM-IGNORE-BEGIN*/37/*DOM-IGNORE-END*/,
     
     /* SWITCH 6 */
     BSP_SWITCH_6 = /*DOM-IGNORE-BEGIN*/PORTS_BIT_POS_13/*DOM-IGNORE-END*/,
...
typedef enum
{
    ...
    /* LED 2 */                                                       
    BSP_LED_2 = /*DOM-IGNORE-BEGIN*/PORTS_BIT_POS_2/*DOM-IGNORE-END*/,
                                                                      
    /* LED 3 */                                                       
    BSP_LED_3 = /*DOM-IGNORE-BEGIN*/PORTS_BIT_POS_3/*DOM-IGNORE-END*/,
                                                                      
    /* LED 4 */                                                       
    BSP_LED_4 = /*DOM-IGNORE-BEGIN*/PORTS_BIT_POS_4/*DOM-IGNORE-END*/,
                                                                      
    /* LED 5 */                                                       
    BSP_LED_5 = /*DOM-IGNORE-BEGIN*/PORTS_BIT_POS_5/*DOM-IGNORE-END*/,
                                                                      
    /* LED 6 */                                                       
    BSP_LED_6 = /*DOM-IGNORE-BEGIN*/PORTS_BIT_POS_6/*DOM-IGNORE-END*/,

    /* LED 7 */
    BSP_LED_7 = /*DOM-IGNORE-BEGIN*/PORTS_BIT_POS_7/*DOM-IGNORE-END*/
	
	/* LED 7 */
//    BSP_LED_8 = /*DOM-IGNORE-BEGIN*/PORTS_BIT_POS_8/*DOM-IGNORE-END*/
