...
void BSP_Initialize(void )
{
    ...
    PLIB_PORTS_PinDirectionInputSet(PORTS_ID_0, PORT_CHANNEL_D, BSP_SWITCH_1);//S3
    PLIB_PORTS_PinDirectionInputSet(PORTS_ID_0, PORT_CHANNEL_D, BSP_SWITCH_2);//S4
    PLIB_PORTS_PinDirectionInputSet(PORTS_ID_0, PORT_CHANNEL_A, BSP_SWITCH_3);//S5
    PLIB_PORTS_PinDirectionInputSet(PORTS_ID_0, PORT_CHANNEL_D, BSP_SWITCH_4);//S6
...
//    TRISBbits.TRISB4 = 1;   //temperature
    PLIB_PORTS_PinDirectionInputSet(PORTS_ID_0, PORT_CHANNEL_B, 2); //pot
    PLIB_PORTS_PinDirectionInputSet(PORTS_ID_0, PORT_CHANNEL_B, 4); //temperature
//	AD1PCFGbits.PCFG0 = 0;
//	AD1PCFGbits.PCFG1 = 0;
	AD1PCFGbits.PCFG2 = 0;
//	AD1PCFGbits.PCFG3 = 0;
