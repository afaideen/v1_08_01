/*******************************************************************************
  ...
  Description:
    This contains routines that implement the board support package for PIC32MX
    Embedded Connectivity (EC) Starter Kit in combination with the Epson
    S1D13517 Board and a WQVGA display.
*******************************************************************************/
