/*******************************************************************************
  ...
  Summary:
    Board Support Package Header File for PIC32MX Embedded Connectivity (EC)
    Starter Kit in combination with the Epson S1D13517 Board and a WQVGA display.

  Description:
    This contains all the configuration that is required to be done for the
    application running on PIC32MX Embedded Connectivity (EC) Starter Kit in
    combination with the Epson S1D13517 Board and a WQVGA display.
*******************************************************************************/
