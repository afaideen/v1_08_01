...
void BSP_Initialize(void )
{
    ...
    PLIB_PORTS_PinClear( PORTS_ID_0, PORT_CHANNEL_D, BSP_MEB_LED_3 );
    PLIB_PORTS_PinClear( PORTS_ID_0, PORT_CHANNEL_C, BSP_MEB_LED_4 - 30 );
    PLIB_PORTS_PinClear( PORTS_ID_0, PORT_CHANNEL_C, BSP_MEB_LED_5 - 30 );
...
void BSP_LEDStateSet(BSP_LED led, BSP_LED_STATE state)
{
    if(led >= 30)
    {
        /* This means the LED is connected to port C */
        PLIB_PORTS_PinWrite ( PORTS_ID_0 , PORT_CHANNEL_C , (led - 30), state );
    }
    else
    {
        /* Switch ON the LED */
...
void BSP_LEDOn(BSP_LED led)
{
    ...
    {
        /* This means the LED is connected to port C */
        PLIB_PORTS_PinSet ( PORTS_ID_0 , PORT_CHANNEL_C , (led - 30));
    }
    else
    {
...
void BSP_LEDOff(BSP_LED led)
{
    ...
    {
        /* This means the LED is connected to port C */
        PLIB_PORTS_PinClear ( PORTS_ID_0 , PORT_CHANNEL_C , (led - 30));
    }
    else
    {
...
BSP_LED_STATE BSP_LEDStateGet(BSP_LED led)
{
    if(led >= 30)
    {
        return(PLIB_PORTS_PinGetLatched(PORTS_ID_0, PORT_CHANNEL_C, (led - 30)));
    }
    else
    {
...
void BSP_LEDToggle(BSP_LED led)
{
    ...
    {
        /* This means the LED is connected to port C */
        PLIB_PORTS_PinToggle ( PORTS_ID_0 , PORT_CHANNEL_C , (led - 30));
    }
    else
    {
...
BSP_SWITCH_STATE BSP_SwitchStateGet( BSP_SWITCH bspSwitch )
{
    ...
    {
        return ( PLIB_PORTS_PinGet(PORTS_ID_0, PORT_CHANNEL_B, (bspSwitch - 30)) );
    }
}
