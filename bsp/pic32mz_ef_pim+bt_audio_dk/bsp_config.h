...
#define DisplayCmdDataConfig()      { TRISJCLR = _TRISJ_TRISJ15_MASK;}
#define DisplaySetCommand()         {LATJCLR = _LATJ_LATJ15_MASK;}
#define DisplaySetData()            {LATJSET = _LATJ_LATJ15_MASK;}

// Definitions for CS pin
#define DisplayConfig()             { TRISACLR = _TRISA_TRISA4_MASK;}
#define DisplayEnable()             { LATACLR = _LATA_LATA4_MASK;}
#define DisplayDisable()            { LATASET = _LATA_LATA4_MASK;}
