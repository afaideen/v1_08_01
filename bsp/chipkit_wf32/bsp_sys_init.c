/*******************************************************************************
  ...
  Summary:
    Board Support Package implementation for chipKIT WF32.
...
void BSP_LEDStateSet(BSP_LED led, BSP_LED_STATE state)
{
	switch (led)
	{
		case BSP_LED_3:
		{
			PLIB_PORTS_PinWrite ( PORTS_ID_0, PORT_CHANNEL_A, PORTS_BIT_POS_0, state );
			break;
		}
		case BSP_LED_4:
		{
			PLIB_PORTS_PinWrite ( PORTS_ID_0, PORT_CHANNEL_A, PORTS_BIT_POS_1, state );
			break;
		}
		case BSP_LED_5:
		{
		...
		case BSP_LED_6:
		{
			PLIB_PORTS_PinWrite ( PORTS_ID_0, PORT_CHANNEL_G, PORTS_BIT_POS_6, state);
			break;
		}
	}
}
...
void BSP_LEDOn(BSP_LED led)
{
    switch (led)
    {
        ...
        case BSP_LED_6:
        {
            PLIB_PORTS_PinSet( PORTS_ID_0, PORT_CHANNEL_G, PORTS_BIT_POS_6);
            break;
        }
    }
}
...
void BSP_LEDOff(BSP_LED led)
{
    switch (led)
    {
        ...
        case BSP_LED_6:
        {
            PLIB_PORTS_PinClear( PORTS_ID_0, PORT_CHANNEL_G, PORTS_BIT_POS_6);
            break;
        }
    }
}
...
BSP_LED_STATE BSP_LEDStateGet(BSP_LED led)
{
    BSP_LED_STATE retVal = BSP_LED_STATE_OFF;
    
    switch (led)
    {
        case BSP_LED_3:
        {
            retVal = PLIB_PORTS_PinGetLatched( PORTS_ID_0, PORT_CHANNEL_A, PORTS_BIT_POS_0);
            break;
        }
        case BSP_LED_4:
        {
            retVal = PLIB_PORTS_PinGetLatched( PORTS_ID_0, PORT_CHANNEL_A, PORTS_BIT_POS_1);
            break;
        }
        case BSP_LED_5:
        {
            retVal = PLIB_PORTS_PinGetLatched( PORTS_ID_0, PORT_CHANNEL_F, PORTS_BIT_POS_0);
            break;
        }
        case BSP_LED_6:
        {
            retVal = PLIB_PORTS_PinGetLatched( PORTS_ID_0, PORT_CHANNEL_G, PORTS_BIT_POS_6);
            break;
        }
    }
    return(retVal);
...
void BSP_LEDToggle(BSP_LED led)
{
    switch (led)
    {
        ...
        case BSP_LED_6:
        {
            PLIB_PORTS_PinToggle( PORTS_ID_0, PORT_CHANNEL_G, PORTS_BIT_POS_6);
            break;
        }
    }
