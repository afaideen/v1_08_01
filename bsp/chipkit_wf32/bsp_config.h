/*******************************************************************************
  ...
  Summary:      
    Board Support Package Header File for Digilent's chipKIT WF32 board (PIC32MX)

  Description:
    This file contains constants, macros, type definitions and function
    declarations required by the chipKIT WF32 board.
*******************************************************************************/
...
{
    /* SWITCH 2 */
     BSP_SWITCH_2 = /*DOM-IGNORE-BEGIN*/PORTS_BIT_POS_6,/*DOM-IGNORE-END*/
