...
#define _TouchScreenChipEnable()     LATGCLR = _LATG_LATG9_MASK
#define _TouchScreenChipDisable()    LATGSET = _LATG_LATG9_MASK
#define _TouchScreenChipDirection()  TRISGCLR = _TRISG_TRISG9_MASK
