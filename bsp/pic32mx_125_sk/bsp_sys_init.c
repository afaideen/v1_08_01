/*******************************************************************************
  ...
  Summary:
    Board Support Package implementation for PIC32MX 1/2/5 Starter Kit.

  Description:
    This file contains routines that implement the board support package for
    PIC32MX 1/2/5 Starter Kit.
*******************************************************************************/
...
{
    return(PLIB_PORTS_PinGet(PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_14));
}
