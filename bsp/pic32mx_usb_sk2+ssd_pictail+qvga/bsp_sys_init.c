/*******************************************************************************
  ...
  Summary:
    Board Support Package Implementation for PIC32MX USB Starter Kit II when used
    along with the Graphics LCD Controller PICtail Plus SSD1926 Board and a QVGA
    Display.

  Description:
    This file contains Board Support Package implementation for PIC32MX USB
    Starter Kit II when used along with the Graphics LCD Controller PICtail Plus
    SSD1926 Board and a QVGA Display.
*******************************************************************************/
