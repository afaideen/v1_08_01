...
void BSP_Initialize(void )
{
    ...
    PLIB_PORTS_PinSet(PORTS_ID_0, PORT_CHANNEL_B, BSP_LED_1);
    PLIB_PORTS_PinSet(PORTS_ID_0, PORT_CHANNEL_B, BSP_LED_2);
    PLIB_PORTS_PinSet(PORTS_ID_0, PORT_CHANNEL_B, BSP_LED_3);
