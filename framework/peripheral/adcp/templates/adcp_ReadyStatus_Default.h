...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _ADCP_READY_STATUS_VREG(index)

  MASKs: 
    _ADCP_READY_STATUS_MASK(index)

  POSs: 
    _ADCP_READY_STATUS_POS(index)

  LENs: 
    _ADCP_READY_STATUS_LEN(index)
...
{
    return _SFR_BIT_READ(_ADCP_READY_STATUS_VREG(index),
            _ADCP_READY_STATUS_POS(index) );
}
