...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _ADCP_SH0_ALT_INPUT_SELECT_VREG(index)

  MASKs: 
    _ADCP_SH0_ALT_INPUT_SELECT_MASK(index)

  POSs: 
    _ADCP_SH0_ALT_INPUT_SELECT_POS(index)

  LENs: 
    _ADCP_SH0_ALT_INPUT_SELECT_LEN(index)
...
PLIB_TEMPLATE void ADCP_AlternateInputSelect_Default(ADCP_MODULE_ID index, ADCP_DSH_ID id) {
    _SFR_FIELD_WRITE(_ADCP_SH0_ALT_INPUT_SELECT_VREG(index),
            _ADCP_SH0_ALT_INPUT_SELECT_MASK(index) << (id * _ADCP_SH0_ALT_INPUT_SELECT_LEN(index)),
            _ADCP_SH0_ALT_INPUT_SELECT_POS(index) + (id * _ADCP_SH0_ALT_INPUT_SELECT_LEN(index)),
            1);
}
