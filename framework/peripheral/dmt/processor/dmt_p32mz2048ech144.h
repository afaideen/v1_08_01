...
PLIB_INLINE SFR_TYPE* _DMT_ON_VREG(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
            return &DMTCON;
...
PLIB_INLINE SFR_TYPE* _DMT_STEP1_VREG(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
            return &DMTPRECLR;
...
PLIB_INLINE SFR_TYPE* _DMT_STEP2_VREG(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
            return &DMTCLR;
...
PLIB_INLINE SFR_TYPE* _DMT_WINOPN_VREG(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
            return &DMTSTAT;
...
PLIB_INLINE SFR_TYPE* _DMT_DMTEVENT_VREG(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
            return &DMTSTAT;
...
PLIB_INLINE SFR_TYPE* _DMT_BAD_VREG(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
            return &DMTSTAT;
...
PLIB_INLINE SFR_TYPE* _DMT_COUNTER_VREG(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
            return &DMTCNT;
...
PLIB_INLINE SFR_TYPE* _DMT_PSCNT_VREG(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
            return &DMTPSCNT;
...
PLIB_INLINE SFR_TYPE* _DMT_PSINTV_VREG(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
            return &DMTPSINTV;
...
PLIB_INLINE SFR_DATA _DMT_ON_MASK(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_STEP1_MASK(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_STEP2_MASK(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_WINOPN_MASK(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_DMTEVENT_MASK(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_BAD_MASK(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_COUNTER_MASK(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_PSCNT_MASK(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_PSINTV_MASK(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_ON_POS(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_STEP1_POS(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_STEP2_POS(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_WINOPN_POS(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_DMTEVENT_POS(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_BAD_POS(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_COUNTER_POS(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_PSCNT_POS(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_PSINTV_POS(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_ON_LEN(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_STEP1_LEN(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_STEP2_LEN(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_WINOPN_LEN(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_DMTEVENT_LEN(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_BAD_LEN(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_COUNTER_LEN(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_PSCNT_LEN(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
...
PLIB_INLINE SFR_DATA _DMT_PSINTV_LEN(DMT_MODULE_ID i)
{
    switch (i) {
        case DMT_ID_0 :
