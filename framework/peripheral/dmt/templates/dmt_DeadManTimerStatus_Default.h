...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _DMT_WINOPN_VREG(index)
    _DMT_DMTEVENT_VREG(index)
    _DMT_BAD_VREG(index)

  MASKs: 
    _DMT_WINOPN_MASK(index)
    _DMT_DMTEVENT_MASK(index)
    _DMT_BAD_MASK(index)

  POSs: 
    _DMT_WINOPN_POS(index)
    _DMT_DMTEVENT_POS(index)
    _DMT_BAD_POS(index)

  LENs: 
    _DMT_WINOPN_LEN(index)
    _DMT_DMTEVENT_LEN(index)
    _DMT_BAD_LEN(index)
...
{
    return (bool)_SFR_BIT_READ(_DMT_WINOPN_VREG(index), _DMT_WINOPN_POS(index) );
}
...
{
    return (bool)_SFR_BIT_READ(_DMT_DMTEVENT_MASK(index), _DMT_DMTEVENT_POS(index) );
}
...
{
    return (bool)_SFR_BIT_READ(_DMT_BAD_VREG(index), _DMT_BAD_POS(index) );
}
...
{
    return (bool)_SFR_BIT_READ(_DMT_BAD_VREG(index), _DMT_BAD_POS(index) + 1 );
}
