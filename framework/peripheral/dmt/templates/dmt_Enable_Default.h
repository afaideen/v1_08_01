...
{
    _SFR_BIT_SET(_DMT_ON_VREG(index),_DMT_ON_POS(index));
}
...
{
     _SFR_BIT_CLEAR(_DMT_ON_VREG(index),_DMT_ON_POS(index));
}
...
{
    return (bool)_SFR_BIT_READ(_DMT_ON_VREG(index), _DMT_ON_POS(index) );
}
