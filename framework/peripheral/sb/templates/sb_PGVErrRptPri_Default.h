...
{
    _SFR_BIT_WRITE(_SB_T0_ERRP_VREG(index) + ((0x400 * target) >> 2), _SB_T0_ERRP_POS(index), 1);
}
...
{
    _SFR_BIT_WRITE(_SB_T0_ERRP_VREG(index) + ((0x400 * target) >> 2), _SB_T0_ERRP_POS(index), 0);
}
