...
PLIB_TEMPLATE void SB_PGRegionReadPermSet_Default( SB_MODULE_ID index , PLIB_SB_TGT_REGION region , PLIB_SB_REGION_PG readPerm )
{
    if (readPerm & REGION_PG_0) {
        _SFR_BIT_WRITE(_SB_T0_R0_RD_GRP0_VREG(index) + (((0x400 * (region >> 8)) + (0x20 * (region & 0xFF))) >> 2), _SB_T0_R0_RD_GRP0_POS(index), 1);
    }
    if (readPerm & REGION_PG_1) {
        _SFR_BIT_WRITE(_SB_T0_R0_RD_GRP1_VREG(index) + (((0x400 * (region >> 8)) + (0x20 * (region & 0xFF))) >> 2), _SB_T0_R0_RD_GRP1_POS(index), 1);
    }
    if (readPerm & REGION_PG_2) {
        _SFR_BIT_WRITE(_SB_T0_R0_RD_GRP2_VREG(index) + (((0x400 * (region >> 8)) + (0x20 * (region & 0xFF))) >> 2), _SB_T0_R0_RD_GRP2_POS(index), 1);
    }
    if (readPerm & REGION_PG_3) {
        _SFR_BIT_WRITE(_SB_T0_R0_RD_GRP3_VREG(index) + (((0x400 * (region >> 8)) + (0x20 * (region & 0xFF))) >> 2), _SB_T0_R0_RD_GRP3_POS(index), 1);
    }
}
...
{
    if (readPerm & REGION_PG_0) {
        _SFR_BIT_WRITE(_SB_T0_R0_RD_GRP0_VREG(index) + (((0x400 * (region >> 8)) + (0x20 * (region & 0xFF))) >> 2), _SB_T0_R0_RD_GRP0_POS(index), 0);
    }
    if (readPerm & REGION_PG_1) {
        _SFR_BIT_WRITE(_SB_T0_R0_RD_GRP1_VREG(index) + (((0x400 * (region >> 8)) + (0x20 * (region & 0xFF))) >> 2), _SB_T0_R0_RD_GRP1_POS(index), 0);
    }
    if (readPerm & REGION_PG_2) {
        _SFR_BIT_WRITE(_SB_T0_R0_RD_GRP2_VREG(index) + (((0x400 * (region >> 8)) + (0x20 * (region & 0xFF))) >> 2), _SB_T0_R0_RD_GRP2_POS(index), 0);
    }
    if (readPerm & REGION_PG_3) {
        _SFR_BIT_WRITE(_SB_T0_R0_RD_GRP3_VREG(index) + (((0x400 * (region >> 8)) + (0x20 * (region & 0xFF))) >> 2), _SB_T0_R0_RD_GRP3_POS(index), 0);
    }
}
