...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _CAN_ACTIVE_STATUS_VREG(index)

  MASKs: 
    _CAN_ACTIVE_STATUS_MASK(index)

  POSs: 
    _CAN_ACTIVE_STATUS_POS(index)

  LENs: 
    _CAN_ACTIVE_STATUS_LEN(index)
...
{
    return _SFR_BIT_READ(_CAN_ACTIVE_STATUS_VREG(index),
                             _CAN_ACTIVE_STATUS_POS(index) );
}
