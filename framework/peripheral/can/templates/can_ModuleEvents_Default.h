...
{
     _SFR_FIELD_CLEAR(_CAN_MODULE_EVENT_GET_TBIF_VREG(index),
						CAN_All_EVENTS,
						_CAN_MODULE_EVENT_GET_TBIF_POS(index) ,
						flags);
}
...
{
     return (CAN_MODULE_EVENT)_SFR_FIELD_READ(_CAN_MODULE_EVENT_GET_TBIF_VREG(index),
							CAN_All_EVENTS ,
							_CAN_MODULE_EVENT_GET_TBIF_POS(index) );
}
