...
#include "../templates/usart_HandShakeMode_Unsupported.h"
...
#include "../templates/usart_OperationMode_Unsupported.h"
...
PLIB_INLINE_API bool PLIB_USART_ExistsHandshakeMode(USART_MODULE_ID index)
{
    switch (index) {
        ...
        case USART_ID_2 :
            return USART_ExistsHandshakeMode_Default(index);
        case USART_ID_4 :
            return USART_ExistsHandshakeMode_Unsupported(index);
        case USART_ID_6 :
            return USART_ExistsHandshakeMode_Unsupported(index);
        case USART_ID_5 :
            return USART_ExistsHandshakeMode_Unsupported(index);
...
PLIB_INLINE_API void PLIB_USART_HandshakeModeSelect(USART_MODULE_ID index, USART_HANDSHAKE_MODE handshakeConfig)
{
    switch (index) {
        ...
        case USART_ID_2 :
            ...
            break;
        case USART_ID_4 :
            USART_HandshakeModeSelect_Unsupported(index, handshakeConfig);
            break;
        case USART_ID_6 :
            USART_HandshakeModeSelect_Unsupported(index, handshakeConfig);
            break;
...
PLIB_INLINE_API bool PLIB_USART_ExistsOperationMode(USART_MODULE_ID index)
{
    switch (index) {
        ...
        case USART_ID_2 :
            return USART_ExistsOperationMode_Default(index);
        case USART_ID_4 :
            return USART_ExistsOperationMode_Unsupported(index);
        case USART_ID_6 :
            return USART_ExistsOperationMode_Unsupported(index);
        case USART_ID_5 :
            return USART_ExistsOperationMode_Unsupported(index);
...
PLIB_INLINE_API void PLIB_USART_OperationModeSelect(USART_MODULE_ID index, USART_OPERATION_MODE operationmode)
{
    switch (index) {
        ...
        case USART_ID_2 :
            ...
            break;
        case USART_ID_4 :
            USART_OperationModeSelect_Unsupported(index, operationmode);
            break;
        case USART_ID_6 :
            USART_OperationModeSelect_Unsupported(index, operationmode);
            break;
