...
PLIB_INLINE SFR_TYPE* _WDT_TIMER_CLEAR_VREG(WDT_MODULE_ID i)
{
    switch (i) {
        case WDT_ID_0 :
            return &WDTCON;
...
PLIB_INLINE SFR_DATA _WDT_TIMER_CLEAR_MASK(WDT_MODULE_ID i)
{
    switch (i) {
        case WDT_ID_0 :
...
PLIB_INLINE SFR_DATA _WDT_TIMER_CLEAR_POS(WDT_MODULE_ID i)
{
    switch (i) {
        case WDT_ID_0 :
...
PLIB_INLINE SFR_DATA _WDT_TIMER_CLEAR_LEN(WDT_MODULE_ID i)
{
    switch (i) {
        case WDT_ID_0 :
