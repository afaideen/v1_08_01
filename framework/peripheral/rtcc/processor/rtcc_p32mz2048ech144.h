...
PLIB_INLINE SFR_TYPE* _RTCC_CLOCK_SELECT_VREG(RTCC_MODULE_ID i)
{
    switch (i) {
        case RTCC_ID_0 :
            return &RTCCON;
...
PLIB_INLINE SFR_DATA _RTCC_CLOCK_SELECT_MASK(RTCC_MODULE_ID i)
{
    switch (i) {
        case RTCC_ID_0 :
            return _RTCCON_RTCCLKSEL_MASK;
        case RTCC_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _RTCC_CLOCK_SELECT_POS(RTCC_MODULE_ID i)
{
    switch (i) {
        case RTCC_ID_0 :
            return _RTCCON_RTCCLKSEL_POSITION;
        case RTCC_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _RTCC_OUTPUT_SELECT_POS(RTCC_MODULE_ID i)
{
    switch (i) {
        case RTCC_ID_0 :
            return _RTCCON_RTCOUTSEL_POSITION;
        case RTCC_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _RTCC_CLOCK_SELECT_LEN(RTCC_MODULE_ID i)
{
    switch (i) {
        case RTCC_ID_0 :
            return _RTCCON_RTCCLKSEL_LENGTH;
        case RTCC_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _RTCC_OUTPUT_SELECT_LEN(RTCC_MODULE_ID i)
{
    switch (i) {
        case RTCC_ID_0 :
            return _RTCCON_RTCOUTSEL_LENGTH;
        case RTCC_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
