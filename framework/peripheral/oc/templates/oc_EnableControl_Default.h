...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _OC_ENABLE_CONTROL_VREG(index)

  MASKs: 
    _OC_ENABLE_CONTROL_MASK(index)

  POSs: 
    _OC_ENABLE_CONTROL_POS(index)

  LENs: 
    _OC_ENABLE_CONTROL_LEN(index)
...
{
    _SFR_BIT_SET(_OC_ENABLE_CONTROL_VREG(index), _OC_ENABLE_CONTROL_POS(index));
}
...
{
    _SFR_BIT_CLEAR(_OC_ENABLE_CONTROL_VREG(index), _OC_ENABLE_CONTROL_POS(index));
}
...
{
return ( _SFR_BIT_READ(_OC_ENABLE_CONTROL_VREG(index), _OC_ENABLE_CONTROL_POS(index)));
}
