...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _OC_CMP_MODE_SEL_VREG(index)

  MASKs: 
    _OC_CMP_MODE_SEL_MASK(index)

  POSs: 
    _OC_CMP_MODE_SEL_POS(index)

  LENs: 
    _OC_CMP_MODE_SEL_LEN(index)
...
{
    _SFR_FIELD_WRITE(_OC_CMP_MODE_SEL_VREG(index),_OC_CMP_MODE_SEL_MASK(index),_OC_CMP_MODE_SEL_POS(index),cmpMode);
}
