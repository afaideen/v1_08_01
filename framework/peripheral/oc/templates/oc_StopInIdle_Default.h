...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _OC_STOP_IN_IDLE_VREG(index)

  MASKs: 
    _OC_STOP_IN_IDLE_MASK(index)

  POSs: 
    _OC_STOP_IN_IDLE_POS(index)

  LENs: 
    _OC_STOP_IN_IDLE_LEN(index)
...
{
    _SFR_BIT_SET(_OC_STOP_IN_IDLE_VREG(index),_OC_STOP_IN_IDLE_POS(index));
}
...
{
    _SFR_BIT_CLEAR(_OC_STOP_IN_IDLE_VREG(index),_OC_STOP_IN_IDLE_POS(index));
}
