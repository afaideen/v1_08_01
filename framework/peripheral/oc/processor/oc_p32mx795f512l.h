...
PLIB_INLINE SFR_TYPE* _OC_TIMER_SELECT_VREG(OC_MODULE_ID i)
{
    switch (i) {
        case OC_ID_1 :
            return &OC1CON;
...
PLIB_INLINE SFR_DATA _OC_TIMER_SELECT_MASK(OC_MODULE_ID i)
{
    switch (i) {
        case OC_ID_1 :
...
PLIB_INLINE SFR_DATA _OC_TIMER_SELECT_POS(OC_MODULE_ID i)
{
    switch (i) {
        case OC_ID_1 :
...
PLIB_INLINE SFR_DATA _OC_TIMER_SELECT_LEN(OC_MODULE_ID i)
{
    switch (i) {
        case OC_ID_1 :
...
#include "../templates/oc_TimerSelect_MX.h"
...
PLIB_INLINE_API bool PLIB_OC_ExistsTimerSelect(OC_MODULE_ID index)
{
    switch (index) {
        case OC_ID_1 :
            return OC_ExistsTimerSelect_MX(index);
        case OC_ID_2 :
            return OC_ExistsTimerSelect_MX(index);
        case OC_ID_3 :
            return OC_ExistsTimerSelect_MX(index);
