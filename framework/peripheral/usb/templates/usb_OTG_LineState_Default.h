...
#ifndef _USB_OTG_LINESTATE_DEFAULT_H
#define _USB_OTG_LINESTATE_DEFAULT_H

//******************************************************************************
/* Routines available for accessing VREGS, MASKS, POS, LEN are 

  VREGs: 
    _USB_LINE_STATE_STABLE_VREG(index)

  MASKs: 
    _USB_LINE_STATE_STABLE_MASK(index)

  POSs: 
    _USB_LINE_STATE_STABLE_POS(index)

  LENs: 
    _USB_LINE_STATE_STABLE_LEN(index)
...
{
    return _SFR_BIT_READ(_USB_LINE_STATE_STABLE_VREG(index),
                         _USB_LINE_STATE_STABLE_POS(index) );
}
...
#endif /*_USB_OTG_LINESTATE_DEFAULT_H*/
