...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _USB_MODULE_BUSY_VREG(index)

  MASKs: 
    _USB_MODULE_BUSY_MASK(index)

  POSs: 
    _USB_MODULE_BUSY_POS(index)

  LENs: 
    _USB_MODULE_BUSY_LEN(index)
...
{
    return _SFR_BIT_READ(_USB_MODULE_BUSY_VREG(index),
                         _USB_MODULE_BUSY_POS(index) );
}
