...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _USB_EP0_LOW_SPEED_CONNECT_ON_VREG(index)

  MASKs: 
    _USB_EP0_LOW_SPEED_CONNECT_ON_MASK(index)

  POSs: 
    _USB_EP0_LOW_SPEED_CONNECT_ON_POS(index)

  LENs: 
    _USB_EP0_LOW_SPEED_CONNECT_ON_LEN(index)
...
/* Function :  USB_EP0LSDirectConnectEnable_Default
  ...
  Description:
    This template implements the Default variant of the PLIB_USB_EP0LSDirectConnectEnable function.
*/

PLIB_TEMPLATE void USB_EP0LSDirectConnectEnable_Default( USB_MODULE_ID index )
{
    SFR_TYPE *reg = _USB_EP0_LOW_SPEED_CONNECT_ON_VREG(index);
    *reg |= _U1EP0_LSPD_MASK;
...
/* Function :  USB_EP0LSDirectConnectDisable_Default
  ...
  Description:
    This template implements the Default variant of the PLIB_USB_EP0LSDirectConnectDisable function.
*/
...
/* Function :  USB_ExistsEP0LowSpeedConnect_Default
  ...
  Description:
    This template implements the Default variant of the PLIB_USB_ExistsEP0LowSpeedConnect function.
*/
