...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _USB_IN_SUSPEND_MODE_VREG(index)

  MASKs: 
    _USB_IN_SUSPEND_MODE_MASK(index)

  POSs: 
    _USB_IN_SUSPEND_MODE_POS(index)

  LENs: 
    _USB_IN_SUSPEND_MODE_LEN(index)
...
{
    _SFR_BIT_SET(_USB_IN_SUSPEND_MODE_VREG(index),
                 _USB_IN_SUSPEND_MODE_POS(index) );
}
...
{
    _SFR_BIT_CLEAR(_USB_IN_SUSPEND_MODE_VREG(index),
                   _USB_IN_SUSPEND_MODE_POS(index) );
}
