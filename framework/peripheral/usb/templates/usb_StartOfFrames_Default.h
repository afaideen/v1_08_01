...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _USB_START_OF_FRAMES_ON_VREG(index)

  MASKs: 
    _USB_START_OF_FRAMES_ON_MASK(index)

  POSs: 
    _USB_START_OF_FRAMES_ON_POS(index)

  LENs: 
    _USB_START_OF_FRAMES_ON_LEN(index)
...
{
    SFR_TYPE *reg = _USB_START_OF_FRAMES_ON_VREG(index);
    *reg |= _U1CON_USBEN_SOFEN_MASK;
