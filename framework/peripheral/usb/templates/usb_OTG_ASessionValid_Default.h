...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _USB_A_SESSION_VALID_VREG(index)

  MASKs: 
    _USB_A_SESSION_VALID_MASK(index)

  POSs: 
    _USB_A_SESSION_VALID_POS(index)

  LENs: 
    _USB_A_SESSION_VALID_LEN(index)
...
{
    return _SFR_BIT_READ(_USB_A_SESSION_VALID_VREG(index),
                         _USB_A_SESSION_VALID_POS(index) );
}
