...
#ifndef _USB_LIVESINGLEENDEDZERO_DEFAULT_H
#define _USB_LIVESINGLEENDEDZERO_DEFAULT_H

//******************************************************************************
/* Routines available for accessing VREGS, MASKS, POS, LEN are 

  VREGs: 
    _USB_LIVE_SE0_VREG(index)

  MASKs: 
    _USB_LIVE_SE0_MASK(index)

  POSs: 
    _USB_LIVE_SE0_POS(index)

  LENs: 
    _USB_LIVE_SE0_LEN(index)
...
{
    return _SFR_BIT_READ(_USB_LIVE_SE0_VREG(index),
                         _USB_LIVE_SE0_POS(index) );
}
...
#endif /*_USB_LIVESINGLEENDEDZERO_DEFAULT_H*/
