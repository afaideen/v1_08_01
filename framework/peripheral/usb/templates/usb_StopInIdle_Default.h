...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _USB_STOP_IN_IDLE_VREG(index)

  MASKs: 
    _USB_STOP_IN_IDLE_MASK(index)

  POSs: 
    _USB_STOP_IN_IDLE_POS(index)

  LENs: 
    _USB_STOP_IN_IDLE_LEN(index)
...
{
    _SFR_BIT_SET(_USB_STOP_IN_IDLE_VREG(index),
                 _USB_STOP_IN_IDLE_POS(index) );
}
...
{
    _SFR_BIT_CLEAR(_USB_STOP_IN_IDLE_VREG(index),
                   _USB_STOP_IN_IDLE_POS(index) );
}
