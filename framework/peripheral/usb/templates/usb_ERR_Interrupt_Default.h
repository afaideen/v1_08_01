...
/* Function :  USB_ErrorInterruptEnable_Default
  ...
  Description:
    This template implements the Default variant of the PLIB_USB_ErrorInterruptEnable function.
*/

PLIB_TEMPLATE void USB_ErrorInterruptEnable_Default( USB_MODULE_ID index , USB_ERROR_INTERRUPTS   interruptFlag )
{
    _SFR_SET(_USB_UnEIE_VAL_VREG(index),interruptFlag);
}
...
/* Function :  USB_ErrorInterruptDisable_Default
  ...
  Description:
    This template implements the Default variant of the PLIB_USB_ErrorInterruptDisable function.
*/

PLIB_TEMPLATE void USB_ErrorInterruptDisable_Default( USB_MODULE_ID index , USB_ERROR_INTERRUPTS   interruptFlag )
{
    _SFR_CLEAR(_USB_UnEIE_VAL_VREG(index),interruptFlag);
}
...
/* Function :  USB_ErrorInterruptIsEnabled_Default
  ...
  Description:
    This template implements the Default variant of the PLIB_USB_ErrorInterruptIsEnabled function.
*/

PLIB_TEMPLATE bool USB_ErrorInterruptIsEnabled_Default( USB_MODULE_ID index , USB_INTERRUPTS interruptFlag )
{
    return ( _SFR_READ(_USB_UnEIE_VAL_VREG(index)) & interruptFlag ? 1 : 0 );
}
...
/* Function :  USB_ExistsERR_Interrupt_Default
  ...
  Description:
    This template implements the Default variant of the PLIB_USB_ExistsERR_Interrupt function.
*/
