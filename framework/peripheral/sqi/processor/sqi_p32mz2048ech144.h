...
PLIB_INLINE SFR_TYPE* _SQI_RECEIVE_DATA_LATCH_CONTROL_VREG(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return &SQI1CFG;
...
PLIB_INLINE SFR_DATA _SQI_RECEIVE_DATA_LATCH_CONTROL_MASK(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
...
PLIB_INLINE SFR_DATA _SQI_BDDONE_INTSIG_ENABLE_MASK(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_BDDONEISE_MASK;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_CONTHR_INTSIG_ENABLE_MASK(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_CONTHRISE_MASK;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_CONEMPTY_INTSIG_ENABLE_MASK(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_CONEMPTYISE_MASK;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_CONFULL_INTSIG_ENABLE_MASK(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_CONFULLISE_MASK;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_RXTHR_INTSIG_ENABLE_MASK(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_RXTHRISE_MASK;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_RXFULL_INTSIG_ENABLE_MASK(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_RXFULLISE_MASK;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_RXEMPTY_INTSIG_ENABLE_MASK(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_RXEMPTYISE_MASK;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_TXTHR_INTSIG_ENABLE_MASK(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_TXTHRISE_MASK;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_TXFULL_INTSIG_ENABLE_MASK(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_TXFULLISE_MASK;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_TXEMPTY_INTSIG_ENABLE_MASK(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_TXEMPTYISE_MASK;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_RECEIVE_DATA_LATCH_CONTROL_POS(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
...
PLIB_INLINE SFR_DATA _SQI_BDDONE_INTSIG_ENABLE_POS(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_BDDONEISE_POSITION;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_CONTHR_INTSIG_ENABLE_POS(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_CONTHRISE_POSITION;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_CONEMPTY_INTSIG_ENABLE_POS(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_CONEMPTYISE_POSITION;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_CONFULL_INTSIG_ENABLE_POS(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_CONFULLISE_POSITION;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_RXTHR_INTSIG_ENABLE_POS(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_RXTHRISE_POSITION;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_RXFULL_INTSIG_ENABLE_POS(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_RXFULLISE_POSITION;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_RXEMPTY_INTSIG_ENABLE_POS(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_RXEMPTYISE_POSITION;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_TXTHR_INTSIG_ENABLE_POS(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_TXTHRISE_POSITION;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_TXFULL_INTSIG_ENABLE_POS(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_TXFULLISE_POSITION;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_TXEMPTY_INTSIG_ENABLE_POS(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_TXEMPTYISE_POSITION;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_RECEIVE_DATA_LATCH_CONTROL_LEN(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
...
PLIB_INLINE SFR_DATA _SQI_BDDONE_INTSIG_ENABLE_LEN(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_BDDONEISE_LENGTH;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_CONTHR_INTSIG_ENABLE_LEN(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_CONTHRISE_LENGTH;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_CONEMPTY_INTSIG_ENABLE_LEN(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_CONEMPTYISE_LENGTH;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_CONFULL_INTSIG_ENABLE_LEN(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_CONFULLISE_LENGTH;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_RXTHR_INTSIG_ENABLE_LEN(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_RXTHRISE_LENGTH;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_RXFULL_INTSIG_ENABLE_LEN(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_RXFULLISE_LENGTH;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_RXEMPTY_INTSIG_ENABLE_LEN(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_RXEMPTYISE_LENGTH;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_TXTHR_INTSIG_ENABLE_LEN(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_TXTHRISE_LENGTH;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_TXFULL_INTSIG_ENABLE_LEN(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_TXFULLISE_LENGTH;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _SQI_TXEMPTY_INTSIG_ENABLE_LEN(SQI_MODULE_ID i)
{
    switch (i) {
        case SQI_ID_0 :
            return _SQI1INTSEN_TXEMPTYISE_LENGTH;
        case SQI_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
