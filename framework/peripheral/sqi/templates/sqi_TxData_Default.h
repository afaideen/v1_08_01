...
/* Routines available for accessing VREGS, MASKS, POS, LEN are
  ...
  VREGs:
    _SQI_TRANSMIT_DATA_VREG(index)

  MASKs:
    _SQI_TRANSMIT_DATA_MASK(index)

  POSs:
    _SQI_TRANSMIT_DATA_POS(index)

  LENs:
    _SQI_TRANSMIT_DATA_LEN(index)
...
{
	_SFR_WRITE (_SQI_TRANSMIT_DATA_VREG(index), data);
}
