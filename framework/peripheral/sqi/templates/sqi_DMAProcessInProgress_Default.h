...
/* Routines available for accessing VREGS, MASKS, POS, LEN are
  ...
  VREGs:
    _SQI_DMA_IN_PROGRESS_VREG(index)

  MASKs:
    _SQI_DMA_IN_PROGRESS_MASK(index)

  POSs:
    _SQI_DMA_IN_PROGRESS_POS(index)

  LENs:
    _SQI_DMA_IN_PROGRESS_LEN(index)
...
{
	return (bool) _SFR_BIT_READ (_SQI_DMA_IN_PROGRESS_VREG(index),
								 _SQI_DMA_IN_PROGRESS_POS(index));
}
