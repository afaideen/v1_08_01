...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _PMP_START_READ_VREG(index)

  MASKs: 
    _PMP_START_READ_MASK(index)

  POSs: 
    _PMP_START_READ_POS(index)

  LENs: 
    _PMP_START_READ_LEN(index)
...
{
    _SFR_BIT_SET( _PMP_START_READ_VREG(index), _PMP_START_READ_POS(index) );
}
...
{
    return (_SFR_BIT_READ(_PMP_START_READ_VREG(index),_PMP_START_READ_POS(index)));
}
