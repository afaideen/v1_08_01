...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _PMP_DUAL_READ_IN1_VREG(index)
    _PMP_OUT1_VREG(index)

  MASKs: 
    _PMP_DUAL_READ_IN1_MASK(index)
    _PMP_OUT1_MASK(index)

  POSs: 
    _PMP_DUAL_READ_IN1_POS(index)
    _PMP_OUT1_POS(index)

  LENs: 
    _PMP_DUAL_READ_IN1_LEN(index)
    _PMP_OUT1_LEN(index)
...
{
    return (( uint16_t )_SFR_READ ( _PMP_DUAL_READ_IN1_VREG (index)));	
}
