...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _PMP_WAIT_STATES_STROBE_VREG(index)

  MASKs: 
    _PMP_WAIT_STATES_STROBE_MASK(index)

  POSs: 
    _PMP_WAIT_STATES_STROBE_POS(index)

  LENs: 
    _PMP_WAIT_STATES_STROBE_LEN(index)
...
{
     _SFR_FIELD_WRITE(	_PMP_WAIT_STATES_STROBE_VREG(index),
						_PMP_WAIT_STATES_STROBE_MASK(index),
						_PMP_WAIT_STATES_STROBE_POS(index),
						strobeWaitState);
}
