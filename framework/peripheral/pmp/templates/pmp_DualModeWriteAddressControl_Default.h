...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _PMP_DUAL_WRITE_ADDRESS_CONTROL_VREG(index)

  MASKs: 
    _PMP_DUAL_WRITE_ADDRESS_CONTROL_MASK(index)

  POSs: 
    _PMP_DUAL_WRITE_ADDRESS_CONTROL_POS(index)

  LENs: 
    _PMP_DUAL_WRITE_ADDRESS_CONTROL_LEN(index)
...
{
    return(_SFR_READ( _PMP_DUAL_WRITE_ADDRESS_CONTROL_VREG ( index ) ));
}
