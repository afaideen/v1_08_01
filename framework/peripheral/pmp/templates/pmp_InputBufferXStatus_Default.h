...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _PMP_INPUT_BUFFERX_STATUS_VREG(index)

  MASKs: 
    _PMP_INPUT_BUFFERX_STATUS_MASK(index)

  POSs: 
    _PMP_INPUT_BUFFERX_STATUS_POS(index)

  LENs: 
    _PMP_INPUT_BUFFERX_STATUS_LEN(index)
...
{
    return (_SFR_BIT_READ(	_PMP_INPUT_BUFFERX_STATUS_VREG(index),
							(_PMP_INPUT_BUFFERX_STATUS_POS(index) + buffer))
			);
