...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _PMP_WRITE_ENABLE_STROBE_PORT_VREG(index)

  MASKs: 
    _PMP_WRITE_ENABLE_STROBE_PORT_MASK(index)

  POSs: 
    _PMP_WRITE_ENABLE_STROBE_PORT_POS(index)

  LENs: 
    _PMP_WRITE_ENABLE_STROBE_PORT_LEN(index)
