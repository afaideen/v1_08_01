...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _PMP_READ_WRITE_STROBE_PORT_VREG(index)

  MASKs: 
    _PMP_READ_WRITE_STROBE_PORT_MASK(index)

  POSs: 
    _PMP_READ_WRITE_STROBE_PORT_POS(index)

  LENs: 
    _PMP_READ_WRITE_STROBE_PORT_LEN(index)
