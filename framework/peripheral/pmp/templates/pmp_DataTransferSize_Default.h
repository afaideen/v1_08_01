...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _PMP_DATA_TRANSFER_SIZE_VREG(index)

  MASKs: 
    _PMP_DATA_TRANSFER_SIZE_MASK(index)

  POSs: 
    _PMP_DATA_TRANSFER_SIZE_POS(index)

  LENs: 
    _PMP_DATA_TRANSFER_SIZE_LEN(index)
...
{
    _SFR_FIELD_WRITE(	_PMP_DATA_TRANSFER_SIZE_VREG(index),
						_PMP_DATA_TRANSFER_SIZE_MASK(index),
						_PMP_DATA_TRANSFER_SIZE_POS(index),
						size);
}
