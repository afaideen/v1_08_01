...
{
case 0:
return (EBI_STATIC_MEMORY_WIDTH)_SFR_FIELD_READ( _EBI_SMDWIDTH0_VREG(index), _EBI_SMDWIDTH0_MASK(index), _EBI_SMDWIDTH0_POS(index));
break;

case 1:
return (EBI_STATIC_MEMORY_WIDTH)_SFR_FIELD_READ( _EBI_SMDWIDTH1_VREG(index), _EBI_SMDWIDTH1_MASK(index), _EBI_SMDWIDTH1_POS(index));
break;

case 2:
return (EBI_STATIC_MEMORY_WIDTH)_SFR_FIELD_READ( _EBI_SMDWIDTH2_VREG(index), _EBI_SMDWIDTH2_MASK(index), _EBI_SMDWIDTH2_POS(index));
break;
