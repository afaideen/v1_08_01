/*******************************************************************************
  ...
  File Name:
    ebi_ChipSelectEnable_Default.h
...
#ifndef _EBI_CHIPSELECTENABLE_DEFAULT_H
#define _EBI_CHIPSELECTENABLE_DEFAULT_H
...
//******************************************************************************
/* Function :  EBI_ChipSelectEnableSet_Default

  Summary:
    Implements Default variant of PLIB_EBI_ChipSelectEnableSet 

  Description:
    This template implements the Default variant of the PLIB_EBI_ChipSelectEnableSet function.
*/

PLIB_TEMPLATE void EBI_ChipSelectEnableSet_Default( EBI_MODULE_ID index , bool ChipSelect0 , bool ChipSelect1 , bool ChipSelect2 , bool ChipSelect3 )
{
...
//******************************************************************************
/* Function :  EBI_ExistsChipSelectEnable_Default

  Summary:
    Implements Default variant of PLIB_EBI_ExistsChipSelectEnable

  Description:
    This template implements the Default variant of the PLIB_EBI_ExistsChipSelectEnable function.
*/

#define PLIB_EBI_ExistsChipSelectEnable PLIB_EBI_ExistsChipSelectEnable
PLIB_TEMPLATE bool EBI_ExistsChipSelectEnable_Default( EBI_MODULE_ID index )
{
    return true;
}


#endif /*_EBI_CHIPSELECTENABLE_DEFAULT_H*/
