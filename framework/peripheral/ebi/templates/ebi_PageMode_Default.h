...
PLIB_TEMPLATE bool EBI_PageModeGet_Default( EBI_MODULE_ID index , int ChipSelectNumber )
{
	...
	{
	case 0:
	return _SFR_FIELD_READ(_EBI_PAGEMODE0_VREG(index), _EBI_PAGEMODE0_MASK(index),_EBI_PAGEMODE0_POS(index));
	break;

	case 1:
	return _SFR_FIELD_READ(_EBI_PAGEMODE1_VREG(index), _EBI_PAGEMODE1_MASK(index),_EBI_PAGEMODE1_POS(index));
	break;

	case 2:
	return _SFR_FIELD_READ(_EBI_PAGEMODE2_VREG(index), _EBI_PAGEMODE2_MASK(index),_EBI_PAGEMODE2_POS(index));
	break;
