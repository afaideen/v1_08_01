...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _EBI_EBIRDYEN1_VREG(index)
    _EBI_EBIRDYINV1_VREG(index)

  MASKs: 
    _EBI_EBIRDYEN1_MASK(index)
    _EBI_EBIRDYINV1_MASK(index)

  POSs: 
    _EBI_EBIRDYEN1_POS(index)
    _EBI_EBIRDYINV1_POS(index)

  LENs: 
    _EBI_EBIRDYEN1_LEN(index)
    _EBI_EBIRDYINV1_LEN(index)
...
{
    _SFR_BIT_WRITE(_EBI_EBIRDYEN1_VREG(index), _EBI_EBIRDYEN1_POS(index), ReadyPin1Enable);
    _SFR_BIT_WRITE(_EBI_EBIRDYINV1_VREG(index), _EBI_EBIRDYINV1_POS(index), ReadyPin1Invert);
