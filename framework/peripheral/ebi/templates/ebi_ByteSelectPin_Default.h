...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _EBI_EBIBSEN0_VREG(index)
    _EBI_EBIBSEN1_VREG(index)

  MASKs: 
    _EBI_EBIBSEN0_MASK(index)
    _EBI_EBIBSEN1_MASK(index)

  POSs: 
    _EBI_EBIBSEN0_POS(index)
    _EBI_EBIBSEN1_POS(index)

  LENs: 
    _EBI_EBIBSEN0_LEN(index)
    _EBI_EBIBSEN1_LEN(index)
...
{
    _SFR_BIT_WRITE(_EBI_EBIBSEN0_VREG(index), _EBI_EBIBSEN0_POS(index), ByteSelect0);
    _SFR_BIT_WRITE(_EBI_EBIBSEN1_VREG(index), _EBI_EBIBSEN1_POS(index), ByteSelect1);
}
