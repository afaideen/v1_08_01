...
PLIB_INLINE SFR_TYPE* _EBI_CSADDR0_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBICS0;
...
PLIB_INLINE SFR_TYPE* _EBI_CSADDR1_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBICS1;
...
PLIB_INLINE SFR_TYPE* _EBI_CSADDR2_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBICS2;
...
PLIB_INLINE SFR_TYPE* _EBI_CSADDR3_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBICS3;
...
PLIB_INLINE SFR_TYPE* _EBI_REGSEL0_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBIMSK0;
...
PLIB_INLINE SFR_TYPE* _EBI_MEMTYPE0_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBIMSK0;
...
PLIB_INLINE SFR_TYPE* _EBI_MEMSIZE0_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBIMSK0;
...
PLIB_INLINE SFR_TYPE* _EBI_REGSEL1_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBIMSK1;
...
PLIB_INLINE SFR_TYPE* _EBI_MEMTYPE1_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBIMSK1;
...
PLIB_INLINE SFR_TYPE* _EBI_MEMSIZE1_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBIMSK1;
...
PLIB_INLINE SFR_TYPE* _EBI_REGSEL2_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBIMSK2;
...
PLIB_INLINE SFR_TYPE* _EBI_MEMTYPE2_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBIMSK2;
...
PLIB_INLINE SFR_TYPE* _EBI_MEMSIZE2_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBIMSK2;
...
PLIB_INLINE SFR_TYPE* _EBI_REGSEL3_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBIMSK3;
...
PLIB_INLINE SFR_TYPE* _EBI_MEMTYPE3_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBIMSK3;
...
PLIB_INLINE SFR_TYPE* _EBI_MEMSIZE3_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBIMSK3;
...
PLIB_INLINE SFR_TYPE* _EBI_RDYMODE0_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT0;
...
PLIB_INLINE SFR_TYPE* _EBI_PAGESIZE0_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT0;
...
PLIB_INLINE SFR_TYPE* _EBI_TPRC0_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT0;
...
PLIB_INLINE SFR_TYPE* _EBI_TBTA0_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT0;
...
PLIB_INLINE SFR_TYPE* _EBI_TWP0_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT0;
...
PLIB_INLINE SFR_TYPE* _EBI_TWR0_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT0;
...
PLIB_INLINE SFR_TYPE* _EBI_TAS0_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT0;
...
PLIB_INLINE SFR_TYPE* _EBI_TRC0_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT0;
...
PLIB_INLINE SFR_TYPE* _EBI_PAGEMODE0_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT0;
...
PLIB_INLINE SFR_TYPE* _EBI_RDYMODE1_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT1;
...
PLIB_INLINE SFR_TYPE* _EBI_PAGESIZE1_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT1;
...
PLIB_INLINE SFR_TYPE* _EBI_TPRC1_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT1;
...
PLIB_INLINE SFR_TYPE* _EBI_TBTA1_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT1;
...
PLIB_INLINE SFR_TYPE* _EBI_TWP1_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT1;
...
PLIB_INLINE SFR_TYPE* _EBI_TWR1_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT1;
...
PLIB_INLINE SFR_TYPE* _EBI_TAS1_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT1;
...
PLIB_INLINE SFR_TYPE* _EBI_TRC1_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT1;
...
PLIB_INLINE SFR_TYPE* _EBI_PAGEMODE1_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT1;
...
PLIB_INLINE SFR_TYPE* _EBI_RDYMODE2_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT2;
...
PLIB_INLINE SFR_TYPE* _EBI_PAGESIZE2_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT2;
...
PLIB_INLINE SFR_TYPE* _EBI_TPRC2_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT2;
...
PLIB_INLINE SFR_TYPE* _EBI_TBTA2_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT2;
...
PLIB_INLINE SFR_TYPE* _EBI_TWP2_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT2;
...
PLIB_INLINE SFR_TYPE* _EBI_TWR2_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT2;
...
PLIB_INLINE SFR_TYPE* _EBI_TAS2_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT2;
...
PLIB_INLINE SFR_TYPE* _EBI_TRC2_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT2;
...
PLIB_INLINE SFR_TYPE* _EBI_PAGEMODE2_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMT2;
...
PLIB_INLINE SFR_TYPE* _EBI_TRPD_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBIFTRPD;
...
PLIB_INLINE SFR_TYPE* _EBI_SMDWIDTH0_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMCON;
...
PLIB_INLINE SFR_TYPE* _EBI_SMDWIDTH1_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMCON;
...
PLIB_INLINE SFR_TYPE* _EBI_SMDWIDTH2_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMCON;
...
PLIB_INLINE SFR_TYPE* _EBI_SMRP_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &EBISMCON;
...
PLIB_INLINE SFR_TYPE* _EBI_EBIPINEN_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &CFGEBIA;
...
PLIB_INLINE SFR_TYPE* _EBI_EBIA0EN_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &CFGEBIA;
...
PLIB_INLINE SFR_TYPE* _EBI_EBIRDYINV3_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &CFGEBIC;
...
PLIB_INLINE SFR_TYPE* _EBI_EBIRDYINV2_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &CFGEBIC;
...
PLIB_INLINE SFR_TYPE* _EBI_EBIRDYINV1_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &CFGEBIC;
...
PLIB_INLINE SFR_TYPE* _EBI_EBIRDYEN3_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &CFGEBIC;
...
PLIB_INLINE SFR_TYPE* _EBI_EBIRDYEN2_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &CFGEBIC;
...
PLIB_INLINE SFR_TYPE* _EBI_EBIRDYEN1_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &CFGEBIC;
...
PLIB_INLINE SFR_TYPE* _EBI_EBIRDYLVL_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &CFGEBIC;
...
PLIB_INLINE SFR_TYPE* _EBI_EBIRPEN_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &CFGEBIC;
...
PLIB_INLINE SFR_TYPE* _EBI_EBIWEEN_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &CFGEBIC;
...
PLIB_INLINE SFR_TYPE* _EBI_EBIOEEN_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &CFGEBIC;
...
PLIB_INLINE SFR_TYPE* _EBI_EBIBSEN1_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &CFGEBIC;
...
PLIB_INLINE SFR_TYPE* _EBI_EBIBSEN0_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &CFGEBIC;
...
PLIB_INLINE SFR_TYPE* _EBI_EBICSEN3_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &CFGEBIC;
...
PLIB_INLINE SFR_TYPE* _EBI_EBICSEN2_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &CFGEBIC;
...
PLIB_INLINE SFR_TYPE* _EBI_EBICSEN1_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &CFGEBIC;
...
PLIB_INLINE SFR_TYPE* _EBI_EBICSEN0_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &CFGEBIC;
...
PLIB_INLINE SFR_TYPE* _EBI_EBIDEN1_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &CFGEBIC;
...
PLIB_INLINE SFR_TYPE* _EBI_EBIDEN0_VREG(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
            return &CFGEBIC;
...
PLIB_INLINE SFR_DATA _EBI_CSADDR0_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_CSADDR1_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_CSADDR2_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_CSADDR3_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_REGSEL0_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_MEMTYPE0_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_MEMSIZE0_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_REGSEL1_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_MEMTYPE1_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_MEMSIZE1_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_REGSEL2_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_MEMTYPE2_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_MEMSIZE2_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_REGSEL3_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_MEMTYPE3_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_MEMSIZE3_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_RDYMODE0_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_PAGESIZE0_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TPRC0_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TBTA0_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TWP0_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TWR0_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TAS0_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TRC0_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_PAGEMODE0_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_RDYMODE1_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_PAGESIZE1_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TPRC1_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TBTA1_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TWP1_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TWR1_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TAS1_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TRC1_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_PAGEMODE1_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_RDYMODE2_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_PAGESIZE2_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TPRC2_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TBTA2_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TWP2_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TWR2_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TAS2_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TRC2_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_PAGEMODE2_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TRPD_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_SMDWIDTH0_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_SMDWIDTH1_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_SMDWIDTH2_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_SMRP_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIPINEN_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIA0EN_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIRDYINV3_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIRDYINV2_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIRDYINV1_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIRDYEN3_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIRDYEN2_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIRDYEN1_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIRDYLVL_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIRPEN_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIWEEN_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIOEEN_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIBSEN1_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIBSEN0_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBICSEN3_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBICSEN2_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBICSEN1_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBICSEN0_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIDEN1_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIDEN0_MASK(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_CSADDR0_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_CSADDR1_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_CSADDR2_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_CSADDR3_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_REGSEL0_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_MEMTYPE0_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_MEMSIZE0_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_REGSEL1_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_MEMTYPE1_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_MEMSIZE1_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_REGSEL2_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_MEMTYPE2_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_MEMSIZE2_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_REGSEL3_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_MEMTYPE3_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_MEMSIZE3_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_RDYMODE0_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_PAGESIZE0_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TPRC0_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TBTA0_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TWP0_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TWR0_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TAS0_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TRC0_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_PAGEMODE0_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_RDYMODE1_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_PAGESIZE1_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TPRC1_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TBTA1_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TWP1_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TWR1_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TAS1_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TRC1_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_PAGEMODE1_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_RDYMODE2_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_PAGESIZE2_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TPRC2_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TBTA2_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TWP2_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TWR2_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TAS2_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TRC2_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_PAGEMODE2_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TRPD_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_SMDWIDTH0_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_SMDWIDTH1_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_SMDWIDTH2_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_SMRP_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIPINEN_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIA0EN_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIRDYINV3_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIRDYINV2_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIRDYINV1_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIRDYEN3_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIRDYEN2_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIRDYEN1_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIRDYLVL_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIRPEN_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIWEEN_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIOEEN_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIBSEN1_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIBSEN0_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBICSEN3_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBICSEN2_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBICSEN1_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBICSEN0_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIDEN1_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIDEN0_POS(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_CSADDR0_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_CSADDR1_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_CSADDR2_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_CSADDR3_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_REGSEL0_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_MEMTYPE0_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_MEMSIZE0_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_REGSEL1_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_MEMTYPE1_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_MEMSIZE1_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_REGSEL2_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_MEMTYPE2_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_MEMSIZE2_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_REGSEL3_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_MEMTYPE3_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_MEMSIZE3_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_RDYMODE0_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_PAGESIZE0_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TPRC0_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TBTA0_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TWP0_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TWR0_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TAS0_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TRC0_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_PAGEMODE0_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_RDYMODE1_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_PAGESIZE1_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TPRC1_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TBTA1_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TWP1_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TWR1_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TAS1_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TRC1_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_PAGEMODE1_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_RDYMODE2_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_PAGESIZE2_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TPRC2_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TBTA2_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TWP2_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TWR2_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TAS2_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TRC2_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_PAGEMODE2_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_TRPD_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_SMDWIDTH0_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_SMDWIDTH1_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_SMDWIDTH2_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_SMRP_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIPINEN_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIA0EN_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIRDYINV3_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIRDYINV2_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIRDYINV1_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIRDYEN3_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIRDYEN2_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIRDYEN1_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIRDYLVL_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIRPEN_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIWEEN_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIOEEN_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIBSEN1_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIBSEN0_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBICSEN3_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBICSEN2_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBICSEN1_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBICSEN0_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIDEN1_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
...
PLIB_INLINE SFR_DATA _EBI_EBIDEN0_LEN(EBI_MODULE_ID i)
{
    switch (i) {
        case EBI_ID_0 :
