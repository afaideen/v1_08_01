...
PLIB_INLINE SFR_TYPE* _IC_TIMER_SELECT_VREG(IC_MODULE_ID i)
{
    switch (i) {
        case IC_ID_1 :
            return &IC1CON;
...
PLIB_INLINE SFR_DATA _IC_TIMER_SELECT_MASK(IC_MODULE_ID i)
{
    switch (i) {
        case IC_ID_1 :
...
PLIB_INLINE SFR_DATA _IC_TIMER_SELECT_POS(IC_MODULE_ID i)
{
    switch (i) {
        case IC_ID_1 :
...
PLIB_INLINE SFR_DATA _IC_TIMER_SELECT_LEN(IC_MODULE_ID i)
{
    switch (i) {
        case IC_ID_1 :
...
#include "../templates/ic_TimerSelect_MX.h"
...
PLIB_INLINE_API bool PLIB_IC_ExistsTimerSelect(IC_MODULE_ID index)
{
    switch (index) {
        case IC_ID_1 :
            return IC_ExistsTimerSelect_MX(index);
        case IC_ID_2 :
            return IC_ExistsTimerSelect_MX(index);
        case IC_ID_3 :
            return IC_ExistsTimerSelect_MX(index);
