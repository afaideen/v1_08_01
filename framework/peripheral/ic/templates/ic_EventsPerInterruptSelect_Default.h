...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _IC_EVENTS_PER_INTERRUPT_VREG(index)

  MASKs: 
    _IC_EVENTS_PER_INTERRUPT_MASK(index)

  POSs: 
    _IC_EVENTS_PER_INTERRUPT_POS(index)

  LENs: 
    _IC_EVENTS_PER_INTERRUPT_LEN(index)
...
{
    _SFR_FIELD_WRITE(_IC_EVENTS_PER_INTERRUPT_VREG(index),_IC_EVENTS_PER_INTERRUPT_MASK(index),
					_IC_EVENTS_PER_INTERRUPT_POS(index), event);
}
