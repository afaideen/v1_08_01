...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _IC_ENABLE_CONTROL_VREG(index)

  MASKs: 
    _IC_ENABLE_CONTROL_MASK(index)

  POSs: 
    _IC_ENABLE_CONTROL_POS(index)

  LENs: 
    _IC_ENABLE_CONTROL_LEN(index)
...
{
    _SFR_BIT_SET(_IC_ENABLE_CONTROL_VREG(index),
				_IC_ENABLE_CONTROL_POS(index));
}
...
{
    _SFR_BIT_CLEAR(_IC_ENABLE_CONTROL_VREG(index),
				_IC_ENABLE_CONTROL_POS(index));
}
