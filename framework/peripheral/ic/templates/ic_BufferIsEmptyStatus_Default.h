...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _IC_BUFFER_IS_EMPTY_STATUS_VREG(index)

  MASKs: 
    _IC_BUFFER_IS_EMPTY_STATUS_MASK(index)

  POSs: 
    _IC_BUFFER_IS_EMPTY_STATUS_POS(index)

  LENs: 
    _IC_BUFFER_IS_EMPTY_STATUS_LEN(index)
...
{
    return (bool)(!(_SFR_BIT_READ(_IC_BUFFER_IS_EMPTY_STATUS_VREG(index),
			_IC_BUFFER_IS_EMPTY_STATUS_POS(index))));
}
