...
// size of the MPFS upload operation write buffer
        ...
        #define MPFS_UPLOAD_WRITE_BUFFER_SIZE       (SYS_FS_MEDIA_MANAGER_BUFFER_SIZE)
#else
            ...
            {// Found it, so remove all data up to and including
                ...
                {   // Read as Ver 2.1
                    ...
                    if(pHttpCon->uploadBufferStart == 0)
                    {
                        ...
                        SYS_CONSOLE_MESSAGE("SYS_FS_Unmount_Wrapper\r\n");
...
//                SYS_CONSOLE_MESSAGE("HTTP_IO_WAITING#");
        ...
        case HTTP_MPFS_WAIT:
            ...
            {   // we're done
                ...
                pHttpCon->uploadBufferStart = 0;
#if defined(DRV_SST25VF016B_CLIENTS_NUMBER)
//                if(SYS_FS_Mount(SYS_FS_MEDIA_IDX0_DEVICE_NAME_VOLUME_IDX0, SYS_FS_MEDIA_IDX0_MOUNT_NAME_VOLUME_IDX0, MPFS2, 0, NULL) == 0)
