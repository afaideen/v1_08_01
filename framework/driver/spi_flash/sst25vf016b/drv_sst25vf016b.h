...
typedef struct
{
    ...
    /* SPI Flash Media start address. The driver treats this address as 
     * block 0 address for read, write and erase operations.
     * */
    uint32_t            mediaStartAddress;
    /* spi flash Media geometry object. */
    const SYS_FS_MEDIA_GEOMETRY *spiflashMediaGeometry;
...
// ****************************************************************************
typedef SYS_FS_MEDIA_BLOCK_COMMAND_HANDLE   DRV_SPIFLASH_COMMAND_HANDLE;
typedef enum
{
    /*Done OK and ready */
    DRV_SPIFLASH_COMMAND_COMPLETED          = SYS_FS_MEDIA_COMMAND_COMPLETED,

    /*Scheduled but not started */
    DRV_SPIFLASH_COMMAND_QUEUED             = SYS_FS_MEDIA_COMMAND_QUEUED,

    /*Currently being in transfer */
    DRV_SPIFLASH_COMMAND_IN_PROGRESS        = SYS_FS_MEDIA_COMMAND_IN_PROGRESS,

    /*Unknown Command */
    DRV_SPIFLASH_COMMAND_ERROR_UNKNOWN      = SYS_FS_MEDIA_COMMAND_UNKNOWN,

} DRV_SPIFLASH_COMMAND_STATUS;
