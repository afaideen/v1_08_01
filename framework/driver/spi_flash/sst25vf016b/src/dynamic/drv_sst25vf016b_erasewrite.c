...
//G:\MicrochipSolutions\harmony\v1_08_01\framework\driver\spi_flash\sst25vf016b\src
...
void DRV_SST25VF016B_EraseWrite
(
    const DRV_HANDLE handle,
...
)
{
    ...
    DRV_SST25VF016B_BLOCK_COMMAND_HANDLE * tempHandle1, tempHandle2;
    
    tempHandle1 = (commandHandle == NULL) ? &tempHandle2 : commandHandle;
    *tempHandle1 = DRV_SST25VF016B_BLOCK_COMMAND_HANDLE_INVALID;

    /* Validate the driver handle */
    clientObj = _DRV_SST25VF016B_DriverHandleValidate(handle);
    _DRV_SST25VF016B_VALIDATE_EXPR((clientObj == NULL), (void)0);
    _DRV_SST25VF016B_VALIDATE_EXPR((sourceBuffer == NULL), (void)0);
    _DRV_SST25VF016B_VALIDATE_EXPR(((writeBlockStart + nWriteBlock) > gSPIFlashGeometryTable[DRV_SST25VF016B_BLOCK_WRITE].numBlocks), (void)0);
    _DRV_SST25VF016B_VALIDATE_EXPR((nWriteBlock == 0), (void)0);

    /* Check if the driver was opened for write */
//    _DRV_SST25VF016B_VALIDATE_EXPR((!(clientObj->intent & DRV_IO_INTENT_WRITE)), (void)0);
...
//    _DRV_SST25VF016B_VALIDATE_EXPR(((writeBlockStart % DRV_NVM_ROW_SIZE) != 0), (void)0);
//
