...
const DRV_SST25VF016B_INIT drvSst25vf016b0InitData =
{
    ...
    .mediaStartAddress = DRV_SST25VF016B_MEDIA_START_ADDRESS_IDX0,
};
...
//NETCONFIG MyConfig =
{
    ...
    0,0,0,      //for ipv6
    .netConfig.interface = &MyConfig.ifName,
    .netConfig.hostName = &MyConfig.nbnsName,
    .netConfig.macAddr = &MyConfig.ifMacAddr,
    .netConfig.ipAddr = &MyConfig.ipAddr,
    .netConfig.ipMask = &MyConfig.ipMask,
    .netConfig.gateway = &MyConfig.gwIP,
    .netConfig.priDNS = &MyConfig.dns1IP,
    .netConfig.secondDNS = &MyConfig.dns2IP,
    .netConfig.powerMode = &MyConfig.pwrMode,
...
SYS_MODULE_OBJ TCPIP_STACK_Init()
{
    ...
    TCPIP_HOSTS_CONFIGURATION[0].startFlags = MyConfig.startFlags;
