...
uint8_t woeid[10] = "56013761";
//uint8_t city[20] = {'?', 0};
uint8_t city[20] = "Segamat";
//uint8_t code[20] = {'3', '2', '0', '0', 0};
uint8_t code[20] = "85000";
...
//            SYS_CONSOLE_MESSAGE("Yahoo Connected...Creating TLS..\r\n");
...
//            SYS_CONSOLE_MESSAGE("Yahoo is SSL Connected..\r\n");
...
//            SYS_CONSOLE_MESSAGE("Get response..\r\n");
...
//                    SYS_CONSOLE_MESSAGE("SSL error...\r\n");
        ...
        case SM_YAHOO_GET_CLOUD_RESPONSE_TEMPERATURE:
            ...
            SYS_CONSOLE_MESSAGE("Response Temperature\r\n");
            uint16_t lenA, lenB, w;
