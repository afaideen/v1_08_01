...
*/
 ...
 SYS_FS_MEDIA_REGION_GEOMETRY SPIFlashGeometryTable[3] = 
{
    {
        .blockSize = 1,
        .numBlocks = 2*1024*1024,
    },
    {
       .blockSize = 1,
       .numBlocks = 2*1024*1024,	//  2M
    },
    {
       .blockSize = 4096,
       .numBlocks = 512
 ...
 const SYS_FS_MEDIA_GEOMETRY SPIFlashGeometry = 
{
    .mediaProperty = SYS_FS_MEDIA_SUPPORTS_BYTE_WRITES,
    .numReadRegions = 1,
    .numWriteRegions = 1,
    .numEraseRegions = 1,
    .geometryTable = (SYS_FS_MEDIA_REGION_GEOMETRY *)&SPIFlashGeometryTable
};
...
const DRV_SST25VF016B_INIT drvSst25vf016b0InitData =
{
    ...
    .mediaStartAddress = 4096,//0x00000000,
    .spiflashMediaGeometry = (SYS_FS_MEDIA_GEOMETRY *)&SPIFlashGeometry
};
