...
NET_PRES_EncProviderObject net_pres_EncProviderDataGramServer0 =
{
    .fpInit =    NET_PRES_EncProviderDataGramServerInit0,
    .fpDeinit =  NET_PRES_EncProviderDataGramServerDeinit0,
    .fpOpen =    NET_PRES_EncProviderDataGramServerOpen0,
    .fpConnect = NET_PRES_EncProviderServerAccept0,
    .fpClose =   NET_PRES_EncProviderConnectionClose0,
    .fpWrite =   NET_PRES_EncProviderWrite0,
    .fpWriteReady =   NET_PRES_EncProviderWriteReady0,
    ...
    .fpReadReady = NET_PRES_EncProviderReadReady0,
    .fpPeek =    NET_PRES_EncProviderPeek0,
    .fpIsInited = NET_PRES_EncProviderDataGramServerIsInited0,
};
NET_PRES_EncProviderObject net_pres_EncProviderDataGramClient0 =
{
    .fpInit =    NET_PRES_EncProviderDataGramClientInit0,
    .fpDeinit =  NET_PRES_EncProviderDataGramClientDeinit0,
    .fpOpen =    NET_PRES_EncProviderDataGramClientOpen0,
    .fpConnect = NET_PRES_EncProviderClientConnect0,
    .fpClose =   NET_PRES_EncProviderConnectionClose0,
    .fpWrite =   NET_PRES_EncProviderWrite0,
    .fpWriteReady =   NET_PRES_EncProviderWriteReady0,
    ...
    .fpReadReady = NET_PRES_EncProviderReadReady0,
    .fpPeek =    NET_PRES_EncProviderPeek0,
    .fpIsInited = NET_PRES_EncProviderDataGramClientIsInited0,
};
net_pres_wolfsslInfo net_pres_wolfSSLInfoStreamServer0;
net_pres_wolfsslInfo net_pres_wolfSSLInfoStreamClient0;
net_pres_wolfsslInfo net_pres_wolfSSLInfoDataGramServer0;
net_pres_wolfsslInfo net_pres_wolfSSLInfoDataGramClient0;
...
int NET_PRES_EncGlue_DataGramServerReceiveCb0(void *sslin, char *buf, int sz, void *ctx)
{
    int fd = *(int *)ctx;
    uint16_t bufferSize;
    bufferSize = (*net_pres_wolfSSLInfoDataGramServer0.transObject->fpReadyToRead)((uintptr_t)fd);
    if (bufferSize == 0)
    {
        return WOLFSSL_CBIO_ERR_WANT_READ;
    }
    bufferSize = (*net_pres_wolfSSLInfoDataGramServer0.transObject->fpRead)((uintptr_t)fd, (uint8_t*)buf, sz);
    return bufferSize;
}
int NET_PRES_EncGlue_DataGramServerSendCb0(void *sslin, char *buf, int sz, void *ctx)
{
    int fd = *(int *)ctx;
    uint16_t bufferSize;
    bufferSize = (*net_pres_wolfSSLInfoDataGramServer0.transObject->fpReadyToWrite)((uintptr_t)fd);
    if (bufferSize == 0)
    {
        return WOLFSSL_CBIO_ERR_WANT_WRITE;
    }

    bufferSize =  (*net_pres_wolfSSLInfoDataGramServer0.transObject->fpWrite)((uintptr_t)fd, (uint8_t*)buf, (uint16_t)sz);
    return bufferSize;
}
int NET_PRES_EncGlue_DataGramClientReceiveCb0(void *sslin, char *buf, int sz, void *ctx)
{
    int fd = *(int *)ctx;
    uint16_t bufferSize;
    bufferSize = (*net_pres_wolfSSLInfoDataGramClient0.transObject->fpReadyToRead)((uintptr_t)fd);
    if (bufferSize == 0)
    {
        return WOLFSSL_CBIO_ERR_WANT_READ;
    }
    bufferSize = (*net_pres_wolfSSLInfoDataGramClient0.transObject->fpRead)((uintptr_t)fd, (uint8_t*)buf, sz);
    return bufferSize;
}
int NET_PRES_EncGlue_DataGramClientSendCb0(void *sslin, char *buf, int sz, void *ctx)
{
    int fd = *(int *)ctx;
    uint16_t bufferSize;
    bufferSize = (*net_pres_wolfSSLInfoDataGramClient0.transObject->fpReadyToWrite)((uintptr_t)fd);
    if (bufferSize == 0)
    {
        return WOLFSSL_CBIO_ERR_WANT_WRITE;
    }

    bufferSize =  (*net_pres_wolfSSLInfoDataGramClient0.transObject->fpWrite)((uintptr_t)fd, (uint8_t*)buf, (uint16_t)sz);
    return bufferSize;
}
...
bool NET_PRES_EncProviderDataGramServerInit0(NET_PRES_TransportObject * transObject)
{
    const uint8_t * serverCertPtr, *serverKeyPtr;
    int32_t serverCertLen, serverKeyLen;
    if (!NET_PRES_CertStoreGetServerCert(&serverCertPtr, &serverCertLen, &serverKeyPtr, &serverKeyLen, 0))
    ...
    net_pres_wolfSSLInfoDataGramServer0.transObject = transObject;
    net_pres_wolfSSLInfoDataGramServer0.context = wolfSSL_CTX_new(wolfDTLSv1_server_method());
    if (net_pres_wolfSSLInfoDataGramServer0.context == 0)
    {
        return false;
    }
    wolfSSL_SetIORecv(net_pres_wolfSSLInfoDataGramServer0.context, (CallbackIORecv)&NET_PRES_EncGlue_DataGramServerReceiveCb0);
    wolfSSL_SetIOSend(net_pres_wolfSSLInfoDataGramServer0.context, (CallbackIOSend)&NET_PRES_EncGlue_DataGramServerSendCb0);
    if (wolfSSL_CTX_use_certificate_buffer(net_pres_wolfSSLInfoDataGramServer0.context, serverCertPtr, serverCertLen, SSL_FILETYPE_ASN1) != SSL_SUCCESS)
    {
        wolfSSL_CTX_free(net_pres_wolfSSLInfoDataGramServer0.context);
        return false;
    }
    if (wolfSSL_CTX_use_PrivateKey_buffer(net_pres_wolfSSLInfoDataGramServer0.context, serverKeyPtr, serverKeyLen, SSL_FILETYPE_ASN1) != SSL_SUCCESS)
    {
        wolfSSL_CTX_free(net_pres_wolfSSLInfoDataGramServer0.context);
        return false;
    }
    // Turn off verification, because SNTP is usually blocked by a firewall
    wolfSSL_CTX_set_verify(net_pres_wolfSSLInfoDataGramServer0.context, SSL_VERIFY_NONE, 0);
    net_pres_wolfSSLInfoDataGramServer0.isInited = true;
    return true;
}
bool NET_PRES_EncProviderDataGramServerDeinit0()
{
    wolfSSL_CTX_free(net_pres_wolfSSLInfoDataGramServer0.context);
    net_pres_wolfSSLInfoDataGramServer0.isInited = false;
    _net_pres_wolfsslUsers--;
    if (_net_pres_wolfsslUsers == 0)
    {
        wolfSSL_Cleanup();
...
bool NET_PRES_EncProviderDataGramServerOpen0(uintptr_t transHandle, void * providerData)
{
        WOLFSSL* ssl = wolfSSL_new(net_pres_wolfSSLInfoDataGramServer0.context);
        if (ssl == NULL)
        {
            return false;
        }
...
bool NET_PRES_EncProviderDataGramServerIsInited0()
{
    return net_pres_wolfSSLInfoDataGramServer0.isInited;
}
bool NET_PRES_EncProviderDataGramClientInit0(NET_PRES_TransportObject * transObject)
{
    const uint8_t * caCertsPtr;
    int32_t caCertsLen;
    if (!NET_PRES_CertStoreGetCACerts(&caCertsPtr, &caCertsLen, 0))
    ...
    net_pres_wolfSSLInfoDataGramClient0.transObject = transObject;
    net_pres_wolfSSLInfoDataGramClient0.context = wolfSSL_CTX_new(wolfDTLSv1_client_method());
    if (net_pres_wolfSSLInfoDataGramClient0.context == 0)
    {
        return false;
    }
    wolfSSL_SetIORecv(net_pres_wolfSSLInfoDataGramClient0.context, (CallbackIORecv)&NET_PRES_EncGlue_DataGramClientReceiveCb0);
    wolfSSL_SetIOSend(net_pres_wolfSSLInfoDataGramClient0.context, (CallbackIOSend)&NET_PRES_EncGlue_DataGramClientSendCb0);
    if (wolfSSL_CTX_load_verify_buffer(net_pres_wolfSSLInfoDataGramClient0.context, caCertsPtr, caCertsLen, SSL_FILETYPE_ASN1) != SSL_SUCCESS)
    {
        // Couldn't load the certificates
        //SYS_CONSOLE_MESSAGE("Something went wrong loading the certificates\r\n");
        wolfSSL_CTX_free(net_pres_wolfSSLInfoDataGramClient0.context);
        return false;
    }
    // Turn off verification, because SNTP is usually blocked by a firewall
    wolfSSL_CTX_set_verify(net_pres_wolfSSLInfoDataGramClient0.context, SSL_VERIFY_NONE, 0);
    net_pres_wolfSSLInfoDataGramClient0.isInited = true;
    return true;
}
bool NET_PRES_EncProviderDataGramClientDeinit0()
{
    wolfSSL_CTX_free(net_pres_wolfSSLInfoDataGramClient0.context);
    net_pres_wolfSSLInfoDataGramClient0.isInited = false;
    _net_pres_wolfsslUsers--;
    if (_net_pres_wolfsslUsers == 0)
    {
        wolfSSL_Cleanup();
...
bool NET_PRES_EncProviderDataGramClientOpen0(uintptr_t transHandle, void * providerData)
{
        WOLFSSL* ssl = wolfSSL_new(net_pres_wolfSSLInfoDataGramClient0.context);
        if (ssl == NULL)
        {
            return false;
        }
...
bool NET_PRES_EncProviderDataGramClientIsInited0()
{
    return net_pres_wolfSSLInfoDataGramClient0.isInited;
}
