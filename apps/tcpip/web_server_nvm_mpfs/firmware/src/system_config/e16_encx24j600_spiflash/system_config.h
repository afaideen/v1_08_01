...
#define TCPIP_SMTP_WRITE_READY_SPACE 	    200
#define TCPIP_SMTP_MAX_WRITE_SIZE   	    512
#define TCPIP_SMTP_TASK_TICK_RATE			21

/*** SNTP Configuration ***/
#define TCPIP_STACK_USE_SNTP_CLIENT
#define TCPIP_NTP_DEFAULT_IF		        		"ENCX24J600"
...
#define TCPIP_TCP_TASK_TICK_RATE		        	3
