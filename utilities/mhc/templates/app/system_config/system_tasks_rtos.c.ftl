...
<#if CONFIG_USE_DRV_TOUCH_MTCH6303 == true && CONFIG_DRV_TOUCH_MTCH6303_RTOS == "Standalone">
OS_STK _DRV_TOUCH_MTCH6303_TasksStk[${CONFIG_DRV_TOUCH_MTCH6303_RTOS_TASK_SIZE}];
</#if>
<#if CONFIG_DRV_USART_INTERRUPT_MODE == false>
<#if CONFIG_DRV_USART_INST_IDX0 == true && CONFIG_DRV_USART_RTOS_IDX0 == "Standalone">
...
<#if CONFIG_USE_DRV_TOUCH_MTCH6303 == true && CONFIG_DRV_TOUCH_MTCH6303_RTOS == "Standalone">
TX_THREAD  _DRV_TOUCH_MTCH6303_Tasks_TCB;
<#assign THREADX_TOTAL_THREADSTK_SIZE = THREADX_TOTAL_THREADSTK_SIZE + CONFIG_DRV_TOUCH_MTCH6303_RTOS_TASK_SIZE?number>
</#if>
<#if CONFIG_DRV_USART_INTERRUPT_MODE == false>
<#if CONFIG_DRV_USART_INST_IDX0 == true && CONFIG_DRV_USART_RTOS_IDX0 == "Standalone">
...
<#if CONFIG_USE_DRV_TOUCH_MTCH6303 == true && CONFIG_DRV_TOUCH_MTCH6303_RTOS == "Standalone">
OS_TASK  _DRV_TOUCH_MTCH6303_Tasks_TCB;
uint32_t _DRV_TOUCH_MTCH6303_TasksStk[${CONFIG_DRV_TOUCH_MTCH6303_RTOS_TASK_SIZE}];
</#if>
...
<#assign DRV_TOUCH_MTCH6303_TASKS = "PROTO">
<#include "/framework/driver/touch/mtch6303/templates/drv_mtch6303_tasks.c.ftl">
</#if>
...
<#if CONFIG_USE_DRV_TOUCH_MTCH6303 == true>
<#assign DRV_TOUCH_MTCH6303_TASKS = "CREATE_TASK">
<#include "/framework/driver/touch/mtch6303/templates/drv_mtch6303_tasks.c.ftl">
</#if>
<#if CONFIG_USE_DRV_TOUCH_ADC10BIT == true>
...
<#if CONFIG_USE_DRV_TOUCH_MTCH6303 == true>
<#assign DRV_TOUCH_MTCH6303_TASKS = "TASK_CALL">
<#include "/framework/driver/touch/mtch6303/templates/drv_mtch6303_tasks.c.ftl">
</#if>
<#if CONFIG_USE_DRV_TOUCH_ADC10BIT == true>
...
<#if CONFIG_USE_DRV_TOUCH_MTCH6303 == true>
<#assign DRV_TOUCH_MTCH6303_TASKS = "LOCAL_FUNCTION">
<#include "/framework/driver/touch/mtch6303/templates/drv_mtch6303_tasks.c.ftl">
</#if>
<#if CONFIG_USE_DRV_TOUCH_ADC10BIT == true>
